...
namespace Hedronoid.ObjectPool
{
    /// <summary>
    /// Object pool manager for managing multiple pools. One per prefab.
    /// </summary>
    public class HNDPoolManager : HNDGameObject
    {
        ...
        [SerializeField]
        private HNDObjectPool[] m_ObjectPools = new HNDObjectPool[0];
        
        protected Dictionary<GameObject, HNDObjectPool> m_ObjectPoolDictionary = new Dictionary<GameObject, HNDObjectPool>();
        ...
        protected override void Awake()
        {
            ...
            {
                foreach (KeyValuePair<GameObject, HNDObjectPool> pair in m_ObjectPoolDictionary)
                {
            ...
            m_ObjectPoolDictionary = new Dictionary<GameObject, HNDObjectPool>();
        ...
        public void CreatePoolFromPrefab(GameObject prefab, int initialPoolSize, bool worldPositionStays = true)
        {
            ...
            if (!m_ObjectPoolDictionary.ContainsKey(prefab))
            {
                ...
                HNDObjectPool pool = objectPoolGO.AddComponent<HNDObjectPool>();
        ...
        public GameObject RentObject(GameObject prefab, Vector3 position, Quaternion rotation, Transform parent, float duration = -1)
        {
            if (m_ObjectPoolDictionary.ContainsKey(prefab))
            {
                ...
                HNDPoolObject pgo = rentedObject.GetComponent<HNDPoolObject>();
                if (pgo != null)
                {
