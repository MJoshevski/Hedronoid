...
namespace Hedronoid.ObjectPool
{
    ...
    /// </summary>
    public class HNDPoolObject : HNDGameObject
    {

        private HNDObjectPool m_OwningPool;
        private HNDPoolManager m_OwningPoolManager;
        ...
        public void SetOwningPool(HNDObjectPool owningPool)
        {
        ...
        public void SetOwningPoolManager(HNDPoolManager owningPoolManager)
        {
