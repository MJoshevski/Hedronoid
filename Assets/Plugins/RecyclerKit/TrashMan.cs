...
namespace Hedronoid
{
    ...
    public class TrashMan : MonoBehaviour
    {
        ...
        IEnumerator internalDespawnAfterDelay(GameObject go, float delayInSeconds, Action despawnAction = null)
        {
        ...
        /// </summary>
        /// <param name="go">Go.</param>
        public static void despawnAfterDelay(GameObject go, float delayInSeconds, Action onDespawnAction = null)
        {
            if (go == null)
                return;

            instance.StartCoroutine(instance.internalDespawnAfterDelay(go, delayInSeconds, onDespawnAction));
        }
