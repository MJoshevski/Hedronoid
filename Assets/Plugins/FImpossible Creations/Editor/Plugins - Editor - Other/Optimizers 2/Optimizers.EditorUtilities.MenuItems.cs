...
namespace FIMSpace.FOptimizing
{
    public static class Optimizers_MenuItems
    {
        ...
        {
            string fullPath = Application.dataPath + "/FImpossible Creations/Plugins/Optimizers 2/Code/Templates/IFLOD_Template.txt";
            CreateScriptAsset("Assets/FImpossible Creations/Plugins/Optimizers 2/Code/Templates/IFLOD_Template.txt", "YourComponentNameHere.cs", fullPath);
        }
