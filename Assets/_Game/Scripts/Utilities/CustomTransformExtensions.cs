...
{ 
    public static class CustomTransformExtensions
    {
        ...
        {
            return CustomTransform.GetGlobal(trans);
        }

        public static CustomTransform ToRelativeTrans(this Transform trans, Transform relativeTo)
        {
            var m = trans.localToWorldMatrix;
            return CustomTransform.Transform(relativeTo.worldToLocalMatrix * m);
        }

        public static CustomTransform ToLocalTrans(this Transform trans)
        {
            return CustomTransform.GetLocal(trans);
        }
        ...
        public static Vector3 ScaleVector(this CustomTransform t, Vector3 v)
        {
        ...
        public static Vector3 InvserScaleVector(this CustomTransform t, Vector3 v)
        {
        ...
        public static Quaternion TransformRotation(CustomTransform t, Quaternion rot)
        {
        ...
        public static Quaternion InverseTransformRotation(CustomTransform t, Quaternion rot)
        {
        ...
        /// <summary>
        /// Apply a transform to a CustomTransform.
        /// </summary>
        /// <param name="m"></param>
        /// <param name="t"></param>
        /// <returns></returns>
        public static CustomTransform TransformTrans(this Matrix4x4 m, CustomTransform t)
        {
            t.Matrix *= m;
            return t;
        }

        public static CustomTransform TransformTrans(this CustomTransform t, CustomTransform t2)
        {
            t2.Matrix *= t.Matrix;
            return t2;
        }

        public static CustomTransform TransformTrans(this Transform t, CustomTransform t2)
        {
            t2.Matrix *= t.localToWorldMatrix;
            return t2;
        }

        public static CustomTransform InverseTransformTrans(this Matrix4x4 m, CustomTransform t)
        {
            t.Matrix *= m.inverse;
            return t;
        }

        public static CustomTransform InverseTransformTrans(this CustomTransform t, CustomTransform t2)
        {
            t2.Matrix *= t.Matrix.inverse;
            return t2;
        }

        public static CustomTransform InverseTransformTrans(this Transform t, CustomTransform t2)
        {
        ...
        public static Ray TransformRay(this CustomTransform t, Ray r)
        {
        ...
        public static Ray InverseTransformRay(this CustomTransform t, Ray r)
        {
        ...
        public static RaycastInfo TransformRayCastInfo(this CustomTransform t, RaycastInfo r)
        {
            float dist = r.Distance;
            var sc = t.Scale;
            if (sc.sqrMagnitude != 1.0f)
        ...
        /// <param name="position">The new position in world space.</param>
        /// <param name="rotation">The new rotation in world space.</param>
        public static void TransposeAroundGlobalAnchor(this Transform trans, CustomTransform anchor, Vector3 position, Quaternion rotation)
        {
        ...
        /// <param name="position">The new position in world space.</param>
        /// <param name="rotation">The new rotation in world space.</param>
        public static void TransposeAroundAnchor(this Transform trans, CustomTransform anchor, Vector3 position, Quaternion rotation)
        {
            if (trans.parent != null)
            {
                position = trans.parent.InverseTransformPoint(position);
        ...
        public static void LocalTransposeAroundAnchor(this Transform trans, CustomTransform anchor, Vector3 position, Quaternion rotation)
        {
