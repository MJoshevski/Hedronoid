...
namespace MDKShooter
{
    ...
    public class CharacterController : MonoSingleton<CharacterController>
    {
        ...
        void HandleAirborneMovement()
        {
            ...
            Vector3 extraGravityForce = (m_Gravity * GravityUp * m_AirborneGravityMultiplier) - (m_Gravity * GravityUp);
        ...
        void MoveForward()
        {
            ...
            if (GravityUp.x == 0) velocity.y = m_Rigidbody.velocity.y;
        ...
        void FixedUpdate()
        {
            ...
            m_Rigidbody.AddForce(GravityUp * m_Gravity * m_GravityMultiplier);
            ...
            //Debugging
            GravityUp = m_GravityPullVector.normalized * -1;
            m_TotalPull = GravityUp * m_Gravity * m_GravityMultiplier;
