...
namespace DanmakU
{
    ...
    public class DanmakuPool : IEnumerable<Danmaku>, IDisposable
    {
        ...
        internal NativeArray<Vector3> OldPositions;
        ...
        internal DanmakuPool(int poolSize)
        {
            ...
            OldPositions = new NativeArray<Vector3>(poolSize, Allocator.Persistent, NativeArrayOptions.UninitializedMemory);
        ...
        internal JobHandle Update(JobHandle dependency = default(JobHandle))
        {
            ...
            new NativeSlice<Vector3>(OldPositions, 0, count).CopyFrom(new NativeSlice<Vector3>(Positions, 0, count));
