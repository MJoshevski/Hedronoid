...
/// </summary>
public abstract class UbhBaseShot_Burst : HNDMonoBehaviour, IGameplaySceneContextInjector
{
    ...
    private UbhShotCtrl_Burst m_shotCtrl;
    private BulletPoolManager BulletPoolManager;
    public UbhShotCtrl_Burst shotCtrl
    {
        get
        {
            if (m_shotCtrl == null)
            {
                m_shotCtrl = transform.GetComponentInParent<UbhShotCtrl_Burst>();

                if (m_shotCtrl == null)
                {
                    m_shotCtrl = transform.parent.GetComponentInParent<UbhShotCtrl_Burst>();
                }
            }
            return m_shotCtrl;
        }
    ...
    /// UbhShotCtrl setter.
    /// </summary>
    public void SetShotCtrl(UbhShotCtrl_Burst shotCtrl)
    {
        m_shotCtrl = shotCtrl;
    }
